...
| [pressure.md](pressure.md) | Cache policy under memory pressure: why cache-off is the ceiling on a >RAM model, why the adaptive governor was retired, and what the fixed `--cache-mb` / `--dense-weights` levers do. |
